Music:
	...
	dba_audio Music_LookKimonoGirl
	dba_audio Music_UnionCave
	dba_audio Music_JohtoWildBattle
	dba_audio Music_JohtoTrainerBattle
	dba_audio Music_Route30
	dba_audio Music_EcruteakCity
	dba_audio Music_VioletCity
	dba_audio Music_JohtoGymBattle
	dba_audio Music_ChampionBattle
	dba_audio Music_RivalBattle
	dba_audio Music_RocketBattle
	dba_audio Music_ElmsLab
	dba_audio Music_DarkCave
